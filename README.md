...
rm src/interact.ts
```
buka file index.ts dan ganti/isi dengan script berikut
```
import { OracleExample } from './OracleExample.js';

export { OracleExample };
```
Buat file baru pada folder src klik kanan new file beri nama : CreditScoreOracle.ts
...
import {
  ...
  ```
  Buat lagi file di src beri nama OracleExampleScaffold.ts kemudian isi dengan script berikut
  ```
  import {
  Field,
  SmartContract,
...
```
Buat lagi file di src dan beri nama OracleExample.ts kemudian isi dengan script berikut
```
import {
  Field,
  SmartContract,
...
```
Buat lagi file di folder src dan beri nama OracleExample.test.ts kemudian isi dengan script berikut
```
